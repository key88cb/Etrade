...
def run_task(stub, task_id: str, task_type: str, config: dict = None, 
             batch_id: str = "", experiment_id: str = "", trigger: str = "MANUAL"):
    """提交并启动一个新任务"""
    print(f"\n{'='*60}")
...
def stream_logs(stub, task_id: str):
    ...
    try:
        ...
        for log_entry in log_stream:
            ...
            print(f"{level_color}[{log_entry.timestamp}] {log_entry.level:5s}{reset_color} {log_entry.message}")
            sys.stdout.flush()
